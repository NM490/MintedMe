...
import { VerificationDialog2 } from "../dialogs/verification-dialog2";

export default function BrowseCard({ nft, address, img, size, ...props }) {
    ...
    >
      ...
      <CardContent className="space-y-4 mt-auto">
        ...
        <div className="flex items-center gap-4 pt-2">
          ...
          <VerificationDialog2 project={nft} walletAddress={address} />
